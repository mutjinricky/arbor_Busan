...
import { ACTION_TYPES } from '../data/sites.js'
import { estimateActionCost } from '../lib/costFormula.js'
...
export default function AddRecordModal({ site, onClose, onSave }) {
  const [form, setForm] = useState({
    ...
    manager: '',
    contractor: '',
    cost_krw: estimateActionCost('현장점검', site),
    next_inspection_date: plusMonths(today(), 6)
  })

  useEffect(() => {
    setForm((f) => ({ ...f, cost_krw: estimateActionCost(f.action_type, site) }))
  }, [form.action_type, site])
