                ...
                >
                  ...
                  <Td>
                    <div className="flex items-center gap-1 font-medium text-slate-900">
                      ...
                      {s._coord_approx && (
                        <span
                          title="좌표 근사 — 원본 데이터에 좌표 없거나 부정확하여 시군 중심·도로구간 평균 좌표 사용"
                          className="inline-flex items-center rounded-sm border border-slate-300 bg-slate-50 px-1 text-[9px] font-semibold text-slate-500"
                        >
                          ≈
                        </span>
                      )}
