        ...
        <div className="space-y-3 px-5 py-4">
          ...
          <div className="rounded-md border border-amber-200 bg-amber-50/50 px-3 py-2 text-[11px] text-slate-700">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div>
                <a
                  href="/samples/demo_highrisk_complaints_gyeonggi.csv"
                  download
                  className="inline-flex items-center gap-1 text-red-700 hover:underline"
                >
                  📥 demo_highrisk_complaints_gyeonggi.csv
                </a>
                <span className="ml-1.5 text-slate-500">
                  — 40건, 산불·재선충 집중 민원 (A등급 시연용)
                </span>
              </div>
            </div>
          </div>
