...
// 출처: 기획서 9.1 (DRYAD 산림 AI · 경기 31개 시군 1차 파일럿)
...
// 등급 임계값 — 기획서 9.2 그대로 사용.
// 경기 기본 데이터는 산불·홍수 위험이 낮은 시도라 종합점수가 36~61에 집중되어
// 기본 상태에서 A·B 등급이 거의 없는 것이 자연스러운 분포 (정직).
// 시연용 임팩트는 demo_highrisk_*.csv 업로드 + 민원 가산점으로 자연스럽게 생성.
export const GRADE_THRESHOLDS = { A: 80, B: 60, C: 40 }
